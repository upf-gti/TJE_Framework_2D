...
A C++ simple 2D game framework, it just creates a window, reads input and allows to load/draw sprites.
...
```
git clone --recurse-submodules -j8 https://github.com/upf-gti/TJE_Framework_2D.git
```
